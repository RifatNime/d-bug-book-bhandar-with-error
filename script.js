...
showBooks(bookList);  //boi dekhasse
...
const displayWishlist = () => {
  ...
  // bookList.forEach((book) => { //bug
    wishlist.forEach((book) => {  //fixed
    const div = createCard(book);
    document.getElementById("wishlist").appendChild(div); //click a bar bar add hosse
  });
};
